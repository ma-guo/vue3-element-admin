...
export const setFilesUpload = (
  data: AdminCore.NoneReq
): Promise<Rsp<AdminCore.V1FilesUploadRsp>> => {
 ...
 * @returns AdminCore.NoneRsp
 */
export const setFilesDelete = (
  data: AdminCore.V1FilesDeleteReq
): Promise<Rsp<AdminCore.NoneRsp>> => {
 ...
 */
export const getVendorZones = (
  data: AdminCore.NoneReq
): Promise<Rsp<AdminCore.V1FilesZoneRsp>> => {
...
export const getVendorList = (
  data: AdminCore.NoneReq
): Promise<Rsp<AdminCore.V1FilesVendorsRsp>> => {
...
export const getVendorPage = (
  data: AdminCore.V1VendorPageReq
): Promise<Rsp<AdminCore.V1VendorPageRsp>> => {
 ...
 */
export const getVendorForm = (
  data: AdminCore.V1VendorFormReq
): Promise<Rsp<AdminCore.V1VendorFormRsp>> => {
 ...
 * @returns AdminCore.NoneRsp
 */
export const setVendorUpdate = (
  data: AdminCore.V1VendorUpdateReq
): Promise<Rsp<AdminCore.NoneRsp>> => {
